<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ContactDemo.aspx.cs" Inherits="ContactDemo" Title="Gold Key Solutions, Inc: Contact Us"
        ...
        <div id="content-main-three-column">
            ...
            <div>
                ...
                <table style="width: 90%;">
                    ...
                    <tr>
                        <td style="width: 146px; height: 120px; margin-left: 40px">
                            Date for Demo:
                            <asp:TextBox ID="DemoDate" runat="server" Width="100"></asp:TextBox>
                            <asp:Image ID="CalendarImage" runat="server" ImageUrl="Images/Calendar_scheduleHS.png" />
                            <ajaxToolkit:CalendarExtender ID="CalendarExtenderDemo" runat="server" TargetControlID="DemoDate"
                                PopupButtonID="CalendarImage" BehaviorID="CalendarExtenderDemo">
                            </ajaxToolkit:CalendarExtender>

                            <script type="text/javascript">
                            function pageLoad(sendor,e)
                            {
                            var calendarBehavior=$find("CalendarExtenderDemo");
                            calendarBehavior.set_selectedDate('<%=DateTime.Now.AddDays(1).ToShortDateString() %>');
                            }
                            </script>

                            <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="DemoDate"
                                ValidationGroup="OIR"></asp:RangeValidator>
                        </td>
                        <td style="width: 30px">
                            <asp:RequiredFieldValidator ID="DemoDateRequired" runat="server" ErrorMessage="Demo Date is Required" ControlToValidate="DemoDate">*</asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        <td style="margin-left: 80px; text-align: center;" colspan="4">
                            <br />
                            <asp:Button ID="OIRSubmit" runat="server" Text="Submit" ValidationGroup="OIR" OnClick="OIRSubmit_Click"
                                TabIndex="12" />
                            <br />
                            <br />
                            <br />
