/****** 
	...
	Modified Date: 04/08/2012
	Description: Update the GoldKey database to level 81067
...
IF (@DbLevel < '81067')
	BEGIN
		-- Increase the field size in ConciergePlus table to handle current profile security
		-- change to allow the Delete Profile option and increase all others so we won't run
		-- out of room for any future security application change.
		BEGIN
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Tabs] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Globals] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Contacts] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Events] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Logbook] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Messages] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Profiles] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Administration] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Maintenance] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [Future1] [varchar](50) NULL
			ALTER TABLE [dbo].[ConciergePlus] ALTER COLUMN [AddOns] [varchar](50) NULL
		END
		-- We need to update the DBLevel. 
		BEGIN
			UPDATE [dbo].[GlobalValues]
			SET [dbo].[GlobalValues].[DbUpdateLevel] = '81067'
		END		
	END
ELSE
	PRINT 'You must be at DbLevel 81067 or older to run this section of script.'	