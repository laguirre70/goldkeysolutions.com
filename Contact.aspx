<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Contact.aspx.cs" Inherits="Contact" Title="Gold Key Solutions, Inc: Contact Us"
...
-->
  ...
  -->
        <div id="content-side1-three-column">
            ...
            <p>
                18757 Burbank Boulevard, Suite 212
<br />Los Angeles, CA. 91356
<br />
                USA<br />
                Tel: 818-865-0006
                <br />
            ...
            <div>
                ...
                <table style="width: 90%;">
                    ...
                    <tr>
                        ...
                        <td style="width: 155px">
                            Job Function:<br />
                            <asp:DropDownList ID="TitleDDL" runat="server" TabIndex="9" 
                                ValidationGroup="OIR">
                    ...
                    <tr>
                        ...
                        <td style="width: 155px">
                            ...
                            <asp:DropDownList ID="RelTypeDDL" runat="server" ValidationGroup="OIR" 
                                TabIndex="10">
                    ...
                    <tr>
                        <td style="width: 146px; margin-left: 40px">
                            Your Inquiry:<br />
                            <asp:TextBox ID="InquiryTB" runat="server" TextMode="MultiLine" Rows="5" 
                                TabIndex="6"></asp:TextBox><br />
                        </td>
                        <td style="width: 30px">
                            &nbsp;<asp:RequiredFieldValidator ID="InquiryRequired" runat="server" ControlToValidate="InquiryTB"
                                ErrorMessage="Your Inquiry is required." ToolTip="Your Inquiry is required."
                                ValidationGroup="OIR">*</asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        <td style="margin-left: 80px" colspan="4">
                            ...
                            <asp:Panel ID="ContentPanelOptionalInfo" runat="server" CssClass="collapsePanel">
                                ...
                                <asp:CheckBox ID="IWantDemoCB" runat="server" Text="YES, I want a Product Demonstration" />
                            </asp:Panel>
                        </td>
                    </tr>
                    <tr>
