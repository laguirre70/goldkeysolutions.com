...
public class Testimonial
{
   ...
   public Testimonial(
    ...
    public string TestifierTitle
    {
        get { return String.IsNullOrEmpty(_testifierTitle) ? String.Empty : _testifierTitle; }
        set { _testifierTitle = value; }
    }
