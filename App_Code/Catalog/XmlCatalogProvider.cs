        ...
        foreach (DataRow r in itemsTbl.Rows)
        {
            if (childItemIds.Contains((string)r["id"]))
            {
                ...
                curr = new Item((string)r["id"],
                                        ...
                                        (string)r["title"]);
                curr.Description    = (r["description"] is DBNull) ? String.Empty : (string)r["description"];
                curr.Functions      = (r["functions"] is DBNull) ? String.Empty : (string)r["functions"];
                ...
                curr.ImageUrl       = (r["imageUrl"] is DBNull) ? String.Empty : (string)r["imageUrl"];
                curr.ImageAltText   = (r["imageAltText"] is DBNull) ? String.Empty : (string)r["imageAltText"];
                curr.VideoUrl       = (r["videoUrl"] is DBNull) ? String.Empty : (string)r["videoUrl"];
                curr.VideoHeight = (r["videoHeight"] is DBNull) ? String.Empty : (string)r["videoHeight"];
                curr.VideoWidth = (r["videoWidth"] is DBNull) ? String.Empty : (string)r["videoWidth"];
                curr.YouTubeID = (r["youTubeID"] is DBNull) ? String.Empty : (string)r["youTubeID"];
                itemList.Add(curr);
            }
        }
        return itemList; 
